...
const ContactForm = () => {
  ...
  // Classes utilisant tes variables globales (index.css)
  ...
  return (
    <section className="w-full bg-[var(--bg-color)] py-20 px-6" aria-labelledby="contact-title">
      <div className="max-w-2xl mx-auto">
        ...
        {isSubmitted ? (
          <div role="status" className="p-8 border border-[var(--primary-color)] bg-[var(--primary-color)]/5 text-[var(--primary-color)] text-center space-y-4">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8" noValidate>
            ...
            {serverError && (
              <div className="p-4 bg-red-900/20 border border-red-500 text-red-400 text-xs font-mono uppercase tracking-widest">
                {serverError}
              </div>
            )}
