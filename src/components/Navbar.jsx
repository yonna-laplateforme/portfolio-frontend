          ...
          >
            <nav>
              <ul className="space-y-3 md:space-y-5">
                {LINKS.map((link, i) => (
                  <li key={link.path} className="overflow-hidden pb-[0.35em] -mb-[0.35em]">
                    <motion.button
                      initial={{ y: '110%' }}
                      animate={{ y: 0 }}
                      exit={{ y: '110%' }}
                    ...
                    >
                      ...
                      <span className="font-display font-light text-6xl md:text-8xl leading-[1.12] transition-all duration-300 group-hover:italic group-hover:text-brick group-hover:translate-x-4">
                        {link.label}
                      </span>
                    </motion.button>
                  </li>
