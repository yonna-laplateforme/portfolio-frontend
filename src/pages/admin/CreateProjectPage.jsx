  ...
  return (
    <div className="bg-bg text-text-main font-sans p-6 md:p-10 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <h1 className="font-heading text-4xl font-bold uppercase text-(--primary-color) mb-8">
          Nouveau Projet
        </h1>
        ...
        >
          <div className="flex-1 space-y-8">
            <div className="bg-white p-8 border border-(--primary-color)/10 shadow-[0_8px_30px_rgba(0,0,0,0.02)] space-y-6">
              <div className="space-y-2">
                <label className="font-mono text-[10px] font-bold opacity-60 uppercase tracking-widest">
                  Titre du projet *
                </label>
                <input
              ...
              <div className="space-y-3 pt-2 border-t border-(--primary-color)/10">
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    ...
                    className="px-3 bg-(--primary-color) text-white text-[10px] uppercase font-bold cursor-pointer hover:bg-(--accent-color)"
                  >
                    Ajouter
                  </button>
                </div>
            ...
            <div className="bg-white p-8 border border-(--primary-color)/10 shadow-[0_8px_30px_rgba(0,0,0,0.02)]">
              <h3 className="font-heading text-lg uppercase text-(--primary-color) mb-4">
                Images du projet
              </h3>
          ...
          <div className="w-full lg:w-80">
            <div className="bg-white p-8 border border-(--primary-color)/10 shadow-[0_8px_30px_rgba(0,0,0,0.02)] space-y-6 sticky top-8">
              <h3 className="font-heading text-lg uppercase text-(--primary-color) pb-4 border-b border-(--primary-color)/10">
                Statut & Options
              </h3>
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                <input
                  type="checkbox"
                  {...register('isFeatured')}
                  className="w-5 h-5 cursor-pointer accent-(--accent-color)"
                />
                <span className="font-mono text-xs uppercase opacity-80 group-hover:text-(--accent-color) transition-colors">
                  Mettre à la une
                </span>
              </label>
              ...
              <button
                ...
                className="w-full py-4 bg-(--primary-color) text-white text-xs font-mono font-bold uppercase tracking-widest hover:bg-(--accent-color) transition-colors cursor-pointer disabled:opacity-50 mt-4"
              >
